...
public class BotConfig {
    ...
    public static final boolean INCLUDE_RISKY_FLIP = false;
    public static final float MAX_NO_RESTRICTIONS_MARGIN_PERC = 35;
    public static final float MAX_NO_RESTRICTIONS_CASHSTACK_PERC = 0.3f; // The max amount of % money to use for the "risky" flip (without requirements)
